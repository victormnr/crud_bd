...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { availability: @equipment.availability, equip_type_id: @equipment.equip_type_id, secretary_id: @equipment.secretary_id } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { availability: @equipment.availability, equip_type_id: @equipment.equip_type_id, secretary_id: @equipment.secretary_id } }
