...
class ResponsiblesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create responsible" do
    assert_difference('Responsible.count') do
      post responsibles_url, params: { responsible: { addressResp: @responsible.addressResp, cpfResp: @responsible.cpfResp, income: @responsible.income, nameResp: @responsible.nameResp } }
    end
  ...
  test "should update responsible" do
    patch responsible_url(@responsible), params: { responsible: { addressResp: @responsible.addressResp, cpfResp: @responsible.cpfResp, income: @responsible.income, nameResp: @responsible.nameResp } }
