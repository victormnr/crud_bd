...
class RequisitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requisition" do
    assert_difference('Requisition.count') do
      post requisitions_url, params: { requisition: { equipment_id: @requisition.equipment_id, reasonReq: @requisition.reasonReq, responsible_id: @requisition.responsible_id } }
    end
  ...
  test "should update requisition" do
    patch requisition_url(@requisition), params: { requisition: { equipment_id: @requisition.equipment_id, reasonReq: @requisition.reasonReq, responsible_id: @requisition.responsible_id } }
