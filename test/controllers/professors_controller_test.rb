...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { nameProfessor: @professor.nameProfessor, school_id: @professor.school_id } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { nameProfessor: @professor.nameProfessor, school_id: @professor.school_id } }
