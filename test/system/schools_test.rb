...
class SchoolsTest < ApplicationSystemTestCase
  ...
  test "creating a School" do
    ...
    fill_in "Addressschool", with: @school.addressSchool
    fill_in "Director", with: @school.director
    fill_in "Nameschool", with: @school.nameSchool
    fill_in "Secretary", with: @school.secretary_id
